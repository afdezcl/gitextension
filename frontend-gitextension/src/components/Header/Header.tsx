    ...
    <nav id="header" className="bg-white fixed w-full z-10 top-0 shadow">
      <div className="w-full container mx-auto flex flex-wrap items-center justify-between my-4">
        <div className="pl-4 md:pl-0">
          <Link className="flex items-center text-transparent bg-clip-text bg-gradient-to-br from-[#FF6D80] to-[#BA35FE] text-base xl:text-xl no-underline hover:no-underline font-extrabold font-sans" href="/">
            <svg className="fill-current h-6 inline-block text-[#F43EF9] mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
